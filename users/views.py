...
class LoginView(mixins.LoggedOutOnlyView, FormView):
    ...
    initial = {"email": "jowonjang@naver.com"}
...
class UpdateProfileView(mixins.LoggedInOnlyiew, SuccessMessageMixin, UpdateView):
    model = models.User
